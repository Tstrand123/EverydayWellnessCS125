...
import 'package:everyday_wellness_cs125/NewSleepLog.dart';
...
// NOTE: these cannot be const, because they will have hold values obtained from the DB
                              ...
                              Expanded(child:Text("duration: $index", textAlign: TextAlign.center,)) // TODO: replace $index with reference to data entry from DB
                            ]
                            )
                        ),
